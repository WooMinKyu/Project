  		...
  		<div	class="box1">
  			<div class="wrap">
	  			<ul class="login">
				        ...
				        <% }else { %>
				        <li><a href="/Project/Login.jsp">로그인</a></li>
				        <% } %>
				        <li><a href="/Project/Register.jsp">회원가입</a></li>
	        ...
	        <div class="center">
		        <div class="search">
		        	<form method="GET" onsubmit="검색어 입력했는지 체크하는 자바스크립트함수">
		        		...
		        		<input type="image" src="/Project/img/search_icon.png" width="28px" height="28px" align="absmiddle">
		        	</form>
		        </div>
		        
	    		<!-- 상단 로그인쪽 -->
		        	<ul class="right">
 						<li><a href="/Project/MyPage.jsp"><img src="/Project/img/mypage_icon.png">
 						<p>마이페이지</p></a></li>
			            <li><a href="/Project/Cart.jsp"><img src="/Project/img/cart_icon.png">
			            <p>장바구니</p></a></li>
		            </ul><!-- right -->
        	</div><!-- center -->
        </div><!-- box2 -->
